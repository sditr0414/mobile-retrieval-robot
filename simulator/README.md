...
앱·펌웨어와 같은 관절 순서, 방향과 Mode 1 패킷을 PC에서 확인합니다. STM32나
앱과 직접 통신하지 않으며 실물 동역학을 보증하지 않습니다.
...
- 무게중심·관성·충돌 형상은 시뮬레이션용 근사값입니다.
- 기본 중력은 0이며 토크, 처짐, 충돌 안전과 실물 속도를 검증하지 않습니다.
- 차량 동역학은 없고 `drive_pid.py`는 펌웨어 PID 계산만 재현합니다.
- XYZ 역기구학은 범위에 없습니다.
